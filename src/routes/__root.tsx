...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Raghad Vision AI" },
      { name: "description", content: "Real-time sign-language and speech accessibility kiosk." },
      { name: "author", content: "Raghad Mohammed Yassin Alshawafy" },
      { property: "og:title", content: "Raghad Vision AI" },
      { property: "og:description", content: "Real-time sign-language and speech accessibility kiosk." },
